...
export IMAGE_URL=${IMAGE_URL-rhtap-quay-quay-rhtap-quay.apps.rosa.kx-216e480e72.ltwz.p3.openshiftapps.com/rhtap/rhtap-qe:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-rhdh-qe/saqn3w1cw-python-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.rosa.kx-216e480e72.ltwz.p3.openshiftapps.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.rosa.kx-216e480e72.ltwz.p3.openshiftapps.com}
